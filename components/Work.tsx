...
export default function Work() {
  return (
    <WorkContainer>
      ...
      {/*놀이의발견*/}
      <Divider1x/>
      <WorkTitle>[📃 2020.10 ~ 2022.06 / 놀이의발견 / 플랫폼실 백엔드파트 / 파트장 ]</WorkTitle>
      <WorkDescriptionContainer>
      ...
      <WorkDescriptionContainer>
        <WorkDescriptionTitle>▶️ 라스트마일 물류 웹서비스 개발</WorkDescriptionTitle>
      </WorkDescriptionContainer>
      <Divider1x/>
      <WorkDescriptionDetail>
        {
      ...
      <WorkDescriptionContainer>
        <WorkDescriptionTitle>▶️ 디지털사이니지 웹 솔루션 개발</WorkDescriptionTitle>
      </WorkDescriptionContainer>
      <Divider1x/>
      <WorkDescriptionDetail>
        {
